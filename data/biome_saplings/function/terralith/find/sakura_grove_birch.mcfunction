...
execute if block ~ ~1.62 ~ #biome_saplings:permeable unless block ~ ~1.62 ~ minecraft:birch_sapling positioned ^ ^ ^.05 run function biome_saplings:terralith/find/sakura_grove_birch



advancement revoke @s only biome_saplings:terralith/sakura_grove_birch