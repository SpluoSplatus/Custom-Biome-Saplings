...
execute if block ~ ~ ~ dark_oak_sapling[stage=1] run scoreboard players add @s saplings_count 500
execute if block ~ ~ ~ dark_oak_sapling[stage=1] run setblock ~ ~ ~ dark_oak_sapling[stage=0]



execute if score @s saplings_count matches 1000.. run function biome_saplings:blooming_biosphere/grow/badlands_dark_oak
