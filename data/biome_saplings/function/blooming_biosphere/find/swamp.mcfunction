...
execute if block ~ ~1.62 ~ #biome_saplings:permeable unless block ~ ~1.62 ~ minecraft:oak_sapling positioned ^ ^ ^.05 run function biome_saplings:blooming_biosphere/find/swamp





advancement revoke @s only biome_saplings:blooming_biosphere/swamp